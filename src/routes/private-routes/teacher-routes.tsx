...
export const TeacherRoutes = () => {
    return <Routes>
        <Route element={<TeacherLayout />} >
            <Route path={getTeacherRelativePath(TEACHER_URLS.ROOT)} element={<div>teacher </div>} />
            <Route path={getTeacherRelativePath(TEACHER_URLS.TEACHER_DASHBOARD)} element={<div>teacher dashboard </div>} />
